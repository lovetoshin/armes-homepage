    ...
    <div>
      ...
      <Section num="4" title="개인정보의 제3자 제공">
        ...
        <Table
          ...
          rows={[
            ["주식회사 코리아포트원(포트원)", "결제창 제공 및 결제 연동", "결제에 필요한 최소 정보(결제수단·승인정보 등)", "관련 법령에 따른 기간"],
            ["한국결제네트웍스 유한회사(KPN)", "신용카드 결제 승인 및 정산", "결제에 필요한 최소 정보(결제수단·승인정보 등)", "관련 법령에 따른 기간"],
            ["카카오페이 주식회사", "간편결제 처리", "결제에 필요한 최소 정보(결제수단·승인정보 등)", "관련 법령에 따른 기간"],
      ...
      <Section num="5" title="개인정보 처리 위탁">
        ...
        <Table
          ...
          rows={[
            ...
            ["주식회사 코리아포트원(포트원)", "결제창 제공 및 결제 연동", "위탁 계약 기간"],
            ["한국결제네트웍스 유한회사(KPN)", "신용카드 결제 승인 및 정산", "위탁 계약 기간"],
            ["카카오페이 주식회사", "간편결제 처리", "위탁 계약 기간"],
      ...
      <Section num="11" title="개인정보 처리방침의 변경">
        <p>
          이 개인정보 처리방침은 2026년 8월 24일부터 적용됩니다. 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.
        </p>
        <div className="mt-4 p-5 rounded-2xl bg-[#F8FAFF] border border-[#E5E8EB] space-y-1">
          <p className="text-sm text-[#8B95A1]">이전 버전: 2024년 12월 1일 ~ 2026년 8월 23일</p>
