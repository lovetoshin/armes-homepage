...
const CARDS: Card[] = [
  ...
  { tag: "판매중", name: "그로스박스", lead: "쿠팡 로켓그로스 재고·발주 자동관리", emoji: "📦",
    ...
    price: "30일 무료체험 · 월 29,900원 · 연 299,000원", href: "https://www.armes.co.kr/sellerai/growthbox", cta: "시작하기", primary: true },
    ...
    <main className="ds">
      ...
      <style>{`
        ...
        .ds{
          ...
          width:100%;padding:140px 0 72px;position:relative;
        }
        .ds .hero{text-align:center;max-width:1080px;margin:0 auto 48px;padding:0 24px;width:100%;box-sizing:border-box}
        .ds .hero h1{font-size:76px;font-weight:800;letter-spacing:-.04em;line-height:1;margin:0 0 20px}
        .ds .tagline{font-size:27px;font-weight:700;letter-spacing:-.02em;color:var(--t1);margin:0 0 14px;line-height:1.2}
        .ds .lede{font-size:19px;color:var(--t2);margin:0;line-height:1.5}
        .ds .shelf{display:grid;grid-template-columns:1fr 1fr;gap:24px;align-items:stretch;max-width:1080px;margin:0 auto;width:100%;padding:0 24px;box-sizing:border-box}
        .ds .card{display:flex;gap:24px;background:var(--bg);border-radius:22px;padding:34px 32px;
          box-shadow:var(--shadow);transition:box-shadow .3s,transform .3s;text-align:left;align-items:flex-start}
        .ds .card:hover{box-shadow:var(--shadow-h);transform:translateY(-5px)}
        .ds .emoji{flex:0 0 auto;font-size:56px;line-height:1;margin-top:2px}
        .ds .body{flex:1;display:flex;flex-direction:column;min-width:0}
        .ds .tag{align-self:flex-start;font-size:12px;font-weight:600;color:var(--t2);background:var(--gray);padding:5px 12px;border-radius:980px;margin-bottom:14px}
        ...
        .ds .card h3{font-size:25px;font-weight:800;letter-spacing:-.02em;margin:0 0 6px}
        .ds .lead{font-size:16px;font-weight:700;color:var(--blue);margin:0 0 14px;line-height:1.4}
        .ds .copy{margin:0 0 22px}
        .ds .copy p{font-size:14.5px;line-height:1.62;color:var(--t1);margin:0 0 9px}
        .ds .copy p:last-child{margin-bottom:0}
        .ds .foot{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-top:auto}
        .ds .price{font-size:13.5px;font-weight:600;color:var(--t3)}
        .ds .cta{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;
          padding:12px 30px;border-radius:980px;font-size:15px;font-weight:700;transition:all .2s;white-space:nowrap;
        ...
        @media (max-width:820px){
          ...
          .ds .card{padding:28px 24px;gap:18px}
          .ds .emoji{font-size:44px}
        }
