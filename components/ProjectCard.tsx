...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  const inner = (
    <>
      {hasThumb ? (
        <div className="relative aspect-[16/10] bg-[#F2F4F6] overflow-hidden">
  ...
  const cardClass =
    "flex flex-col bg-white rounded-3xl border border-[#E5E8EB] overflow-hidden h-full transition-shadow";
