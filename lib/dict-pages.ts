...
export const ABOUT: Record<Locale, AboutDict> = {
  ...
  en: {
    ...
    metaDesc:
      "ARMES is an everyday-life service company solving daily inconveniences with data, automation and location technology. Meet our mission and vision, CEO Jihan Shin's 16 years in retail, and our business areas.",
    heroTitle: "An everyday-life service company that removes daily inconveniences",
    heroDesc:
      "ARMES Inc. builds and operates real-life services across many fields, using data, automation and location technology.",
    missionTitle: "Bring technology into everyday life",
    missionDesc:
      "No matter how good a technology is, it means nothing if it isn't used in everyday life. ARMES turns complex technology into services anyone can use easily, aiming to bring real help to business owners and everyday consumers.",
    visionTitle: "An everyday-life service company expanding across fields",
    visionDesc:
      "Starting from commerce and reaching into local life, travel and content — we extend the capabilities proven in one field to the next, so ARMES services naturally accompany many moments of daily life.",
    values: [
      { title: "Technology that gets used", desc: "We build tools used every day in the field, not just in demos. Technology matters when it solves real, everyday problems." },
    ...
    founderStory:
      "I spent 16 years on the front lines of retail — selling products, meeting customers and facing real problems first-hand, learning what truly gets in the way. On that experience, I founded ARMES so that technology could take over the tasks business owners repeat every day. We put tools that actually get used in the field ahead of flashy technology.",
    founderPhotoAlt: "Jihan Shin, CEO of ARMES Inc.",
    areas: [
      { title: "Commerce automation", desc: "Image and detail-page automation for online sellers", ref: "SellerAI" },
  ...
  "zh-Hans": {
    ...
    metaDesc:
      "ARMES是一家运用数据、自动化与位置技术解决日常不便的生活服务公司。了解我们的使命与愿景、代表申智汉16年的流通经验，以及业务领域。",
    heroTitle: "解决日常不便的生活服务公司",
    heroDesc:
      "ARMES株式会社运用数据、自动化与位置技术，亲自打造并运营多个领域的日常生活服务。",
    missionTitle: "让技术触及日常",
    missionDesc:
      "再好的技术，若无法用于日常便毫无意义。ARMES将复杂的技术打造成人人都能轻松使用的服务，致力于为做生意的人和日常消费者带来切实的帮助。",
    visionTitle: "向多个领域拓展的生活服务公司",
    visionDesc:
      "从电商起步，延伸至本地生活、旅行与内容——我们将在一个领域验证过的能力拓展到下一个领域，让ARMES的服务自然融入日常生活的诸多时刻。",
    values: [
      { title: "真正被使用的技术", desc: "我们打造的是在现场每天被使用的工具，而非演示品。技术只有在解决日常问题时才有意义。" },
    ...
    founderStory:
      "我在流通现场度过了16年。卖商品、见客户、亲身经历现场的问题，学会了“什么才是真正的不便”。基于这些经验，我创办了ARMES，让技术替做生意的人完成每天重复的工作。比起华丽的技术，我们更看重在现场真正被使用的工具。",
    founderPhotoAlt: "ARMES株式会社代表 申智汉",
    areas: [
      { title: "电商自动化", desc: "为网店卖家提供的图片与详情页自动化", ref: "SellerAI" },
  ...
  "zh-Hant": {
    ...
    metaDesc:
      "ARMES是一家運用資料、自動化與位置技術解決日常不便的生活服務公司。了解我們的使命與願景、代表申智漢16年的流通經驗，以及業務領域。",
    heroTitle: "解決日常不便的生活服務公司",
    heroDesc:
      "ARMES株式會社運用資料、自動化與位置技術，親自打造並營運多個領域的日常生活服務。",
    missionTitle: "讓技術觸及日常",
    missionDesc:
      "再好的技術，若無法用於日常便毫無意義。ARMES將複雜的技術打造成人人都能輕鬆使用的服務，致力於為做生意的人與日常消費者帶來切實的幫助。",
    visionTitle: "向多個領域拓展的生活服務公司",
    visionDesc:
      "從電商起步，延伸至在地生活、旅行與內容——我們將在一個領域驗證過的能力拓展到下一個領域，讓ARMES的服務自然融入日常生活的諸多時刻。",
    values: [
      { title: "真正被使用的技術", desc: "我們打造的是在現場每天被使用的工具，而非展示品。技術唯有在解決日常問題時才有意義。" },
    ...
    founderStory:
      "我在流通現場度過了16年。賣商品、見客戶、親身經歷現場的問題，學會了「什麼才是真正的不便」。基於這些經驗，我創辦了ARMES，讓技術替做生意的人完成每天重複的工作。比起華麗的技術，我們更重視在現場真正被使用的工具。",
    founderPhotoAlt: "ARMES株式會社代表 申智漢",
    areas: [
      { title: "電商自動化", desc: "為網店賣家提供的圖片與詳情頁自動化", ref: "SellerAI" },
